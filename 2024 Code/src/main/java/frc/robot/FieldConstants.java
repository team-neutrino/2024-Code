...
public final class FieldConstants {
    public static final Map<Integer, Pose3d> tenAprilTags = Map.of(
            1,
            new Pose3d(Units.inchesToMeters(593.68), Units.inchesToMeters(9.68), Units.inchesToMeters(53.38),
                    new Rotation3d(0, 0, (2 * Math.PI) / 3)),
            2,
            new Pose3d(Units.inchesToMeters(637.21), Units.inchesToMeters(34.79), Units.inchesToMeters(53.38),
                    new Rotation3d(0, 0, (2 * Math.PI) / 3)),
            3,
            new Pose3d(Units.inchesToMeters(652.73), Units.inchesToMeters(196.17), Units.inchesToMeters(57.13),
                    new Rotation3d(0, 0, Math.PI)),
            4,
            new Pose3d(Units.inchesToMeters(652.73), Units.inchesToMeters(218.42), Units.inchesToMeters(57.13),
                    new Rotation3d(0, 0, Math.PI)),
            5,
            ...
            new Pose3d(Units.inchesToMeters(72.5), Units.inchesToMeters(323), Units.inchesToMeters(53.38),
                    new Rotation3d(0, 0, (3 * Math.PI) / 2)),
            7,
            new Pose3d(Units.inchesToMeters(-1.5), Units.inchesToMeters(218.42), Units.inchesToMeters(57.13),
                    new Rotation3d()),
            8,
            new Pose3d(Units.inchesToMeters(-1.5), Units.inchesToMeters(196.17), Units.inchesToMeters(57.13),
                    new Rotation3d()),
            9,
            new Pose3d(Units.inchesToMeters(14.02), Units.inchesToMeters(34.79), Units.inchesToMeters(53.38),
                    new Rotation3d(0, 0, Math.PI / 3)),
            10, new Pose3d(Units.inchesToMeters(57.54), Units.inchesToMeters(9.68), Units.inchesToMeters(53.58),
                    new Rotation3d(0, 0, Math.PI / 3)));
    public static final Map<Integer, Pose3d> sixteenAprilTags = Map.of(
            ...
            new Pose3d(Units.inchesToMeters(182.73), Units.inchesToMeters(177.10), Units.inchesToMeters(52),
                    new Rotation3d(0, 0, (2 * Math.PI) / 3)),
            16, new Pose3d(Units.inchesToMeters(182.73), Units.inchesToMeters(146.19), Units.inchesToMeters(52),
                    new Rotation3d(0, 0, (4 * Math.PI) / 3)));

    public static final Double[] autoAlignPoint = { 1.0, 1.0, 1.0, 0.0, 0.0, 0.0 };
}