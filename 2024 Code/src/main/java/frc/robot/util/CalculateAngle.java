...
public class CalculateAngle {
    ...
    public CalculateAngle() {
        ...
        bilinearMap.put(new PolarCoord(2.15, 0), 5.0);
        bilinearMap.put(new PolarCoord(3.1, 0), 11.0);
        bilinearMap.put(new PolarCoord(4.0, 0.0), 15.0);
        bilinearMap.put(new PolarCoord(4.9, 0.0), 16.0);

        bilinearMap.put(new PolarCoord(2.15, pi / 8), 6.5);
        bilinearMap.put(new PolarCoord(3.1, pi / 8), 9.0);
        bilinearMap.put(new PolarCoord(4.0, pi / 8), 14.0);
        bilinearMap.put(new PolarCoord(4.9, pi / 8), 16.5);

        bilinearMap.put(new PolarCoord(2.15, pi / 4), 7.5);
        bilinearMap.put(new PolarCoord(3.1, pi / 4), 12.0);
        bilinearMap.put(new PolarCoord(4.0, pi / 4), 16.0);
        bilinearMap.put(new PolarCoord(4.9, pi / 4), 17.5);
        ...
        // bilinearMap.put(new PolarCoord(2.0, pi / 24), 6.0);
        // bilinearMap.put(new PolarCoord(2.3, pi / 24), 9.0);
        // bilinearMap.put(new PolarCoord(2.55, pi / 24), 10.8);
        // bilinearMap.put(new PolarCoord(2.8, pi / 24), 12.1);
        // bilinearMap.put(new PolarCoord(3.2, pi / 24), 15.1668); // check
        ...
        // bilinearMap.put(new PolarCoord(2.8, pi / 12), 13.5);
        ...
        // bilinearMap.put(new PolarCoord(2.0, pi / 8), 7.0);
        // bilinearMap.put(new PolarCoord(2.3, pi / 8), 9.567);
        // bilinearMap.put(new PolarCoord(2.55, pi / 8), 10.8569);
        // bilinearMap.put(new PolarCoord(2.8, pi / 8), 12.602); // check
        ...
        // bilinearMap.put(new PolarCoord(2.0, pi / 6), 8.0);
        ...
        // bilinearMap.put(new PolarCoord(2.0, pi / 4.8), 7.7);
        // bilinearMap.put(new PolarCoord(2.3, pi / 4.8), 8.62); // check
        // bilinearMap.put(new PolarCoord(2.55, pi / 4.8), 7.428);
        // bilinearMap.put(new PolarCoord(2.8, pi / 4.8), 12.04);
        // bilinearMap.put(new PolarCoord(3.2, pi / 4.8), 15.532); // check
        ...
        // bilinearMap.put(new PolarCoord(2.0, pi / 4), 8.0);
