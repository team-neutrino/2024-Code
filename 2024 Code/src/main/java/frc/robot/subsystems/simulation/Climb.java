...
// DoubleTopic elevator_sim_position_topic1 =
// inst1.getDoubleTopic("climb1/sim_position1");
// DoubleTopic elevator_enc_position_topic1 =
// inst1.getDoubleTopic("climb1/encoder_position1");
// final DoublePublisher elevator_sim_position_pub1;
// final DoublePublisher elevator_position_pub1;

// public Climb() {
// m_elevator_ligament1 = m_root1.append(new MechanismLigament2d("elevator1",
// 12, 0));
// m_elevator_sim1 = new ElevatorSim(DCMotor.getNEO(1), 25.0, 36.29, 0.022225,
// 0.00, 0.5334, true, 0.00);
...
// m_elevator_sim1.setInputVoltage(m_climb1.getAppliedOutput() *
...
// super.periodic();
// elevator_position_pub1.set(m_climbEncoder1.getVelocity(),
