...
// * Motor controllers
// */
// //protected CANSparkMax m_climb1 = new
// CANSparkMax(Constants.MotorIDs.CLIMB_MOTOR1,
// MotorType.kBrushless);
// protected CANSparkMax m_climb2 = new
// CANSparkMax(Constants.MotorIDs.CLIMB_MOTOR2, MotorType.kBrushless);
...
// m_limitSwitch =
// m_climb1.getReverseLimitSwitch(SparkLimitSwitch.Type.kNormallyOpen);
...
// */
// private RelativeEncoder initializeMotor(CANSparkMax p_motorController,
// boolean inverted) {
...
// * {@link ClimbConstants#CLIMB_LIMIT_UP} {@link
// ClimbConstants#CLIMB_LIMIT_DOWN}
// *
...
// m_climb1.setSoftLimit(CANSparkBase.SoftLimitDirection.kForward,
// ClimbConstants.CLIMB_LIMIT_UP);
...
// return new double[] { m_climbEncoder1.getPosition(),
...
// return new double[] { m_climbEncoder1.getVelocity(),
// m_climbEncoder2.getVelocity() };
// }
